...
import (
	...
	"github.com/ahmedheakl/coolgo/ast"
	"github.com/ahmedheakl/coolgo/lexer"
	"github.com/ahmedheakl/coolgo/token"
)
...
func (p *Parser) parseIfExpression() ast.Expression {
	...
	if !p.expectPeek(token.LPAREN) {
		// p.errors = append(p.errors, "Expected left parentheses")
		return nil
	}
